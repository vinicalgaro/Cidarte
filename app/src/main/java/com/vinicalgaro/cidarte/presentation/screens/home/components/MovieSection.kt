package com.vinicalgaro.cidarte.presentation.screens.home.components
...
import com.vinicalgaro.cidarte.presentation.components.SeeMoreItem
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Box(modifier = Modifier.fillMaxWidth()) {
            ...
            Column(
                ...
                SectionHeader(title, modifier = Modifier.padding(start = 8.dp, bottom = 8.dp))
                LazyRow(
                    state = listState,
